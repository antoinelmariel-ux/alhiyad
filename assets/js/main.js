...
function buildOnboardingTour() {
    ...
    const tg = new TourGuideClient({
        ...
        steps: [
            ...
            { title: 'Tableau de bord', target: '#tab-dashboard', content: "Grâce au tableau de bord, vous aurez une vision globale de l’exposition du groupe aux risques éthiques. Seuls 5 risques ont été dévéloppés mais pour un rendu réaliste nous avons créé d'autres risques fictifs, qui apparaissent de façon floutée." },
            { title: 'Entretiens', target: '#tab-interviews', content: 'Cette section contient l’ensemble des comptes-rendus des entretiens réalisés avec les collaborateurs du groupe. Ils démontrent la couverture de l’ensemble de nos processus.' },
            ...
            { title: 'Matrice du risque brut', target: '#matrixGridBrut', content: 'La matrice des risques bruts présente le positionnement des risques inhérents à notre groupe, en fonction de leur probabilité et de leur impact théorique, c-à-d en l’absence de mesures de maîtrise.', dialogPlacement: 'right' },
            { title: 'Matrice du risque net', target: '#matrixGridNet', content: 'La matrice des risques nets présente les risques résiduels, c-à-d en tenant compte de l’efficacité de nos mesures de maitrise.', dialogPlacement: 'bottom' },
