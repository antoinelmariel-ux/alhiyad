...
function buildOnboardingTour() {
    ...
    const tg = new TourGuideClient({
        ...
        steps: [
            ...
            { title: 'Configuration – Contrôles existants', target: '#net-matrix-wrapper', dialogTarget: '#riskFormThemeSection', content: 'Rattachez à ce risque les contrôles et mesure de maitrise faisant partie de votre référentiel', dialogPlacement: 'top-start', forceDialogTopRight: true },
