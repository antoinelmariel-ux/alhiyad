...
function buildOnboardingTour() {
    ...
    const tg = new TourGuideClient({
        ...
        steps: [
            ...
            { title: 'Configuration – Thématique', target: '#riskFormThemeSection', content: 'Choisissez la thématique et les champs métiers associés.', dialogPlacement: 'top-start' },
            ...
            { title: 'Configuration - Facteurs aggravants', target: '#aggravatingFactorsBlock', dialogTarget: '#riskFormThemeSection', content: 'Indiquez les facteurs aggravants. Les facteurs disponibles s’appliquent en fonction du type de risque.', dialogPlacement: 'top-start' },
