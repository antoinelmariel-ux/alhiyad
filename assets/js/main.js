...
function buildOnboardingTour() {
    ...
    const tg = new TourGuideClient({
        ...
        steps: [
            ...
            { title: 'Configuration – Risque net', target: '#net-matrix-wrapper', dialogTarget: '#riskFormThemeSection', content: 'Indiquez le niveau de maîtrise pour passer du risque brut au risque net.', dialogPlacement: 'top-start', forceDialogTopRight: true },
